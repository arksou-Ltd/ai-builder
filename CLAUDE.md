...
**AI Assistants MUST communicate with users in Chinese at all times**
...
- All requirements analysis, architecture design, development implementation, and testing verification must follow BMAD-METHOD workflow
